Pod::Spec.new do |s|
  s.name         = 'TCWebViewJavascriptBridge'
  s.version      = '5.0.5.1'
  s.summary      = 'An iOS/OSX bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.'
  s.homepage     = 'https://github.com/starfalling/WebViewJavascriptBridge'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { 'marcuswestin' => 'marcus.westin@gmail.com' }
  s.requires_arc = true
  s.source       = { :git => 'https://github.com/starfalling/WebViewJavascriptBridge.git', :tag => 'v'+s.version.to_s }
